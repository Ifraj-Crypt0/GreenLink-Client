    ...
    return (
        user ? <> <div className="hero min-h-screen bg-base-200">
            ...
            <div className='bg-yellow-300/40'>
                <form onSubmit={handleEmailSignUp} className="hero bg-base-200 min-h-screen">
                    <div className="hero-content flex-col lg:flex-row-reverse">
                        ...
                        <div className="card bg-white w-full max-w-sm shrink-0 shadow-2xl">
                            <div className="card-body">
                                ...
                                <div className='text-sm italic text-gray-500' >Already have an account? <Link to={"/logIn"}><span className='text-blue-400 hover:underline'>Sign In</span></Link></div>
                            </div>
