...
const BrowseTipsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-green-50 p-6 grid grid-cols-1 gap-6">
            {publicPosts.map(post => (
                <div key={post._id} className="bg-gradient-to-br w-full lg:w-3xl mx-auto from-green-100 to-orange-100 rounded-xl shadow-lg p-5 flex flex-col">
                    {/* User Info */}
